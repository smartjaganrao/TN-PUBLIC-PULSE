...
import { Trophy, MapPin, Globe, Loader2, Database, Trash2, ArrowLeft, Vote, Users, ChevronRight, Share2, Twitter, Facebook, MessageCircle, RefreshCw } from 'lucide-react';
...
const ResultsPage: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'overall' | 'districts' | 'social'>('overall');
            ...
            <div className="lg:col-span-4 bg-zinc-900 text-white rounded-[2.5rem] p-8 flex flex-col items-center text-center justify-center relative overflow-hidden shadow-2xl min-h-[400px]">
              ...
              {overallLeader && (
                <div className="absolute inset-0 opacity-10">
                  <img src={overallLeader.image} alt="" className="w-full h-full object-cover blur-md" />
                </div>
              )}
                ...
                {overallLeader ? (
                  <>
                    <div className="relative">
                      <img src={overallLeader.image} alt="" className="w-32 h-32 rounded-full border-4 border-white/10 mx-auto shadow-2xl bg-white p-2" />
